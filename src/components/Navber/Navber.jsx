        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal px-1">
            <li className="flex-row mr-28">
              ...
              <NavLink to="/review" className="text-white font-semibold	mr-4">Order Review</NavLink>
              <NavLink to="/about" className="text-white font-semibold	mr-4">About</NavLink>
              <NavLink to="/about" className=" font-semibold	mr-4 text-[#FFE0B3]">Sing Up</NavLink>
              <NavLink to="/about" className=" font-semibold	text-[#FFE0B3]">Login</NavLink>
            </li>
          </ul>
        </div>
      </div>
